...
import com.cooltechworks.creditcarddesign.CardSelector.CardTypes;
...
public class CreditCardView extends FrameLayout {
    ...
    interface ICustomCardSelector {
        CardTypes getCardSelector(String cardNumber);
    }
    ...
    public void paintCard(String brand) {

        CardTypes card = selectCard(brand);
    ...
    public void revealCardAnimation() {
        ...
        CardTypes card = selectCard(mBrand);
        ...
        animateChange(cardContainer, cardFront, card.getCardBackground());
    }

    public CardTypes selectCard(String brand) {
        return CardSelector.selectCard(brand);
    }
